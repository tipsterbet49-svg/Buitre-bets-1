...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C7mRa72I.mjs");
...
var manifest = {
	"56a3bfcf5d24fac95689953d10b9ba0a0588e55c9f3efdf0a312153bda121b4e": {
		functionName: "fetchPicks_createServerFn_handler",
		importer: () => import("./fetch-picks-DPVNDE2R.mjs")
	},
	"c934df3e526f3570e1a7f17300945b14fae992187bb6e4db2e6e1e69bcb3fd24": {
		functionName: "askGrok_createServerFn_handler",
		importer: () => import("./ask-grok-By_PPrM9.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-NFUvM60p.mjs").then((n) => n.t),
